...
class TicketInfoShop extends StatefulWidget {
  TicketInfoData data;
  TicketInfoShop({required this.data, super.key});

  @override
  State<TicketInfoShop> createState() => _TicketInfoShopState();
}

class _TicketInfoShopState extends State<TicketInfoShop> {
  @override
